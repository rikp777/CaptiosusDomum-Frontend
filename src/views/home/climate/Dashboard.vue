    ...
    <div class="card mb-4">
      <div class="card-body">
        <div class="d-flex justify-content-between">
          <h2 class="card-title">Climate Dashboard</h2>
        </div>
      </div>
    </div>
    <div class="row">
...
<script>
  import createItem from "../../../components/climate/Add";
  import updateItem from "../../../components/climate/Edit";
  import deleteItem from "../../../components/climate/Delete";
  import listItem from "../../../components/climate/List";
  export default {
